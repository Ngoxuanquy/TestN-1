...
export default function HomeScrenn({ navigation }) {
    ...
    const buttons = [
        {
            id: 1,
            button: 'Thủ Tục Hành Chính',
            icon: 'receipt',
            color: 'coral',
        },
        {
            id: 2,
            button: 'Chỉ Số Cá Nhân',
            icon: 'receipt',
        },
        {
            id: 3,
            button: 'Thông Báo Công Ty',
            icon: 'notifications',
        },
        {
            id: 4,
                ...
                >
                    ...
                    >
                        ...
                        >
                            <View>
                                {thongtin.map((thong) => (
                                    <TouchableOpacity key={thong.id} onPress={() => handerUpAnh()}>
                                        {thong.img == '' ? (
                                            <Image
                                                style={{
                                                    width: 100,
            ...
            >
                ...
                <View style={{}}>
                    ...
                    >
                        {buttons.map((button) => (
                            <TouchableOpacity
                                onPress={() => navigation.navigate(button.button)}
                                key={button.id}
                                style={{
                                    width: 100,
                                    height: 100,
